...
const (
	AggregatorService_AddImageMetadata_FullMethodName = "/aggregator.AggregatorService/AddImageMetadata"
)
...
type AggregatorServiceClient interface {
	AddImageMetadata(ctx context.Context, in *AddImageMetadataRequest, opts ...grpc.CallOption) (*AddImageMetadataResponse, error)
}
...
func (c *aggregatorServiceClient) AddImageMetadata(ctx context.Context, in *AddImageMetadataRequest, opts ...grpc.CallOption) (*AddImageMetadataResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddImageMetadataResponse)
	err := c.cc.Invoke(ctx, AggregatorService_AddImageMetadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AggregatorServiceServer interface {
	AddImageMetadata(context.Context, *AddImageMetadataRequest) (*AddImageMetadataResponse, error)
...
func (UnimplementedAggregatorServiceServer) AddImageMetadata(context.Context, *AddImageMetadataRequest) (*AddImageMetadataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddImageMetadata not implemented")
}
...
func _AggregatorService_AddImageMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddImageMetadataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AggregatorServiceServer).AddImageMetadata(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AggregatorService_AddImageMetadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServiceServer).AddImageMetadata(ctx, req.(*AddImageMetadataRequest))
	}
...
var AggregatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddImageMetadata",
			Handler:    _AggregatorService_AddImageMetadata_Handler,
		},
	},
